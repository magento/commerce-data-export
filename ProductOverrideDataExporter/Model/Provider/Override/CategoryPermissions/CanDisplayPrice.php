...
class CanDisplayPrice
{
    ...
    public function get(array $values): array
    {
        ...
        $output = [];
        $cursor = $this->queryProcessor->execute('productCategoryPermissionsCanDisplayPrice', $queryArguments);
        while ($row = $cursor->fetch()) {
            ...
            $output[$key]['categoryPermissions']['canDisplayPrice'][] = $row['category'];
        }
        return $output;
    }
}
