...
// Create tier prices
$productTierPrices = [];
/** All website tier prices */
$createGroupedPrice($productTierPrices, 0, Group::CUST_GROUP_ALL, 1, 10, null);
$createGroupedPrice($productTierPrices, 0, Group::CUST_GROUP_ALL, 2, 20, null);
$createGroupedPrice($productTierPrices, 0, Group::NOT_LOGGED_IN_ID, 3, null, 15.15);
$createGroupedPrice($productTierPrices, 0, Group::NOT_LOGGED_IN_ID, 4, null, 14.15);
